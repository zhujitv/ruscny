const translations = {
  zh: {
    ...
    featureInviteTitle: '好友私聊与会议邀请', featureInviteText: '好友可直接进行一对一中俄翻译聊天，无需创建会议房间；需要多人参与时，再通过好友、二维码、链接或房间码邀请。私聊只保留消息，不生成 AI 纪要。',
  ...
  ru: {
    ...
    featureInviteTitle: 'Личный чат и приглашения', featureInviteText: 'Друзья могут начать личный китайско-русский чат без комнаты встречи. Для группы доступны приглашение друга, QR-код, ссылка и код комнаты. В личном чате сохраняются сообщения, но ИИ-протокол не создаётся.',
